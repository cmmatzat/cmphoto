<?php
/* ============ Blog Controller ============ */
/*  The Blog Controller launches blog posts
...
class BlogController extends Controller
{
  ...
  ***************************************/
  ...
  /***************************************
    index()
  ----------------------------------------
    Welcome the visitor to the blog
    and provide excerpts of recent posts
  ***************************************/
  public function index( $args = false )
  {
    $welcome = new StandardSection( 'cnt_blog_welcome.php' );
    $welcome->setClass( 'theme-light' );
